...
export default function ProfilePage({ onBack, section, item }: Props) {
  ...
  useEffect(() => {
    document
      .querySelector('.profile-nav-item.active')
  ...
  // Each group is its own address, so a reload, the back button or a pasted link lands
  // on the same one. The route is the state; this only moves it.
      ...
      <div className="profile-layout">
            ...
            {SECTIONS.map((section) => (
              <li key={section.id}>
                <button
                  type="button"
                  className={
                    activeSection === section.id ? 'profile-nav-item active' : 'profile-nav-item'
                  }
        ...
        <main className="profile-body">
          {activeSection === 'account' && (
            ...
            >
              <div className="profile-group-head">
                ...
                <p>Who you are to everyone who shares a glade with you.</p>
              </div>
              ...
              <div className="profile-pair">
                ...
                <section id="setting-picture" className="card">
                  ...
                  {withPicture.length === 0 ? (
                    <p className="hint">
                      Link a GitHub or Google account to use its picture. Until then, your initials
                      stand in.
                    </p>
                  ) : (
                    <div className="avatar-choices">
                      ...
                      {withPicture.map(({ id, label, identity }) => (
                        <button
                          ...
                          type="button"
                          className={
                            user.avatar_source === id ? 'avatar-choice on' : 'avatar-choice'
                          }
                      ...
                      <button
                        type="button"
                        className={
                          user.avatar_source === 'none' ? 'avatar-choice on' : 'avatar-choice'
                        }
          ...
          {activeSection === 'security' && (
            ...
            >
              <div className="profile-group-head">
                <h2 id="profile-security-title">Sign-in and security</h2>
              ...
              <section id="setting-sign-in" className="card">
                ...
                {linked.some(
                  ({ id, identity }) => identity === undefined && providers?.[id] === true,
                ) && (
                  <p className="hint">
        ...
        */}
              <section id="setting-sessions" className="card">
                ...
                <p className="hint">
                  ...
                  that browser has to sign in again.
                </p>
                  ...
                  <ul className="session-list">
                    {sessions.map((session) => {
                      ...
                      return (
                        <li
                          key={session.id}
                          className={session.current ? 'session current' : 'session'}
                        >
            ...
            account gets in, and how it gets out. */}
              <section id="setting-log-out" className="card profile-signout">
                <div className="profile-signout-text">
                  <h3>Log out</h3>
                  <p className="hint">
                    Ends the session on this device only. Your glades stay put.
                  </p>
                </div>
          ...
          {activeSection === 'preferences' && (
            ...
            >
              <div className="profile-group-head">
                ...
                <p>How Meadow looks in this browser.</p>
              </div>
              <div className="profile-pair">
                {/*
          Appearance.
        ...
        */}
                <section id="setting-appearance" className="card">
                  ...
                  <p className="hint">
                    ...
                    system follows it when it changes, including at sunset.
                  </p>
